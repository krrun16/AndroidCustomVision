...
public class ClassifierActivity extends CameraActivity implements OnImageAvailableListener {
  ...
  private static final String INPUT_NAME = "Placeholder";//"input";
  private static final String OUTPUT_NAME = "loss";//"output";
    ...
    runInBackground(
        new Runnable() {
          ...
          public void run() {
            ...
            if(SAVE_PREVIEW_BITMAP) {
              ImageUtils.saveBitmap(croppedBitmap, results);
            }
